...
const Banner = () => {
  return (
    <div style={{ backgroundImage: `url("https://i.ibb.co/RTL5BwB/young-woman-black-t-shirt-with-camera-1.jpg")` }} className="w-full mx-auto h-[91vh] bg-cover bg-right md:bg-center  md:opacity-90 opacity-100">
